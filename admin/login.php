        ...
        <div class="card mx-auto col-8 border-0 shadow-lg" style="border-radius: 10px;">
            <div class="card-body p-0">
                <div class="row">
                    ...
                    <div class="col-7">
                        <p class="lead display-6 mt-3" style="text-decoration:underline green; text-underline-offset:3px; padding-left:3rem;">ADMIN LOGIN</p>
                        ...
                        <?php 
                            if(isset($_POST['login'])){
                                ...
                                $loginQuery = mysqli_query($connect,"select * from user where email='$username' AND password='$password' AND isadmin='$isadmin'");
