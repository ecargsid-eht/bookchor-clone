...
<body style="background-color: #f9f9f9;">
    ...
    <div class="container">
        ...
        if(isset($_GET['find'])){
          ...
          $data = callData("books JOIN category ON books.category=category.cat_id where title like '%$search%' OR isbn = '$search' OR author like '%$search%'");
    ...
    ?>
            <div class="col-lg-3">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <p class="text-center lead text-uppercase fw-light"><?= $data['title'] ?></p>
                            <p class="fs-6 text-success d-inline small fw-bold"> <span class="text-dark fw-normal"> Price -</span> Rs. <?= $data['cost'] ?></p>
                            <a href="view.php?id=<?= $data['id'] ?>" class="btn btn-success stretched-link">Show</a>
                        </div>
                    </div>
            </div>
